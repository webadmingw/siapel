...
<div class="container">
    <div class="row justify-content-start">
        <div class="col-md-6 p-4">
            <h5 class="text-left mb-4" style="padding-bottom: 10px;">Tambah Peserta</h5>
            <form id="register-form" method="post" action="<?= BASE_URL ?>user/createUser"  style="padding: 20px;">
